...
**Why:** During the one-video proof, indexing and metadata checks succeeded and the player rendered a poster, but playback subsequently returned YouTube error 150. This was an external playback restriction, not a failed Twelve Labs search.
